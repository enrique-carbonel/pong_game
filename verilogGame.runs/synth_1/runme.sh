...
HD_PWD='C:/Users/sumes/OneDrive/Personal_work/enrique_carbone/ProjectVerilog/verilogGame.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_pong_game.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_pong_game.tcl
