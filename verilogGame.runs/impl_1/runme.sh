...
HD_PWD='C:/Users/sumes/OneDrive/Personal_work/enrique_carbone/ProjectVerilog/verilogGame.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_pong_game.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_pong_game.tcl -notrace
